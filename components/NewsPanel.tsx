...
const MOCK_NEWS: NewsItem[] = [
  ...
  { id: 3, headline: 'Federal Reserve signals two rate cuts likely in second half of 2025', source: 'WSJ', url: '#', symbols: ['SPY', 'ES1'], created_at: new Date(Date.now() - 1000 * 60 * 58).toISOString() },
  { id: 4, headline: 'Tesla Cybertruck demand disappoints analysts, shares slide in premarket trading', source: 'CNBC', url: '#', symbols: ['TSLA'], created_at: new Date(Date.now() - 1000 * 60 * 90).toISOString() },
  { id: 5, headline: 'Amazon AWS reaches $100B annual revenue run rate as cloud growth accelerates', source: 'FT', url: '#', symbols: ['AMZN'], created_at: new Date(Date.now() - 1000 * 60 * 120).toISOString() },
  { id: 6, headline: 'Gold hits new all-time high as dollar weakens on jobs data miss', source: 'MarketWatch', url: '#', symbols: ['GC1'], created_at: new Date(Date.now() - 1000 * 60 * 145).toISOString() },
  { id: 7, headline: 'Meta advertising revenue beats estimates, AI-driven targeting cited as key driver', source: 'Bloomberg', url: '#', symbols: ['META'], created_at: new Date(Date.now() - 1000 * 60 * 180).toISOString() },
  { id: 8, headline: 'Microsoft Copilot+ PCs drive enterprise software upgrade cycle ahead of expectations', source: 'Reuters', url: '#', symbols: ['MSFT'], created_at: new Date(Date.now() - 1000 * 60 * 210).toISOString() },
  { id: 9, headline: 'Crude oil falls below $78 as OPEC+ considers output increase next quarter', source: 'Reuters', url: '#', symbols: ['CL1'], created_at: new Date(Date.now() - 1000 * 60 * 250).toISOString() },
  { id: 10, headline: 'Alphabet beats earnings estimates for third consecutive quarter, YouTube ads hit record', source: 'CNBC', url: '#', symbols: ['GOOGL'], created_at: new Date(Date.now() - 1000 * 60 * 290).toISOString() },
]
